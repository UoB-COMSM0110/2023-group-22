...
public class Doodler{
  public float jumpConstant = -7;
  public float springConstant = -15;
  ...
  public boolean updateMonster(ArrayList <Monster> monsters){
   for(Monster monster: monsters){
     return rectRect(this.x, this.y, this.width, this.height, monster.x, monster.y, monster.width, monster.height);
   }
   return false;
  }
